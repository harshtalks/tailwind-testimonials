...
const Slider = ({
  ...
  return (
    <div className="w-fit-content md:w-52   h-96 pb-10 h-60 min-w-fit bg-slate-300 mt-10 rounded-md relative border-t-4 border-sky-700 pt-4 ">
      ...
      <div className="text-center py-2 px-3 flex flex-col justify-center items-center">
        ...
        <h2 className="tracking-wide font-bold tracking-wide md:text-xl text-teal-900">
          {data.name}
        </h2>
        <div>
          <Image
